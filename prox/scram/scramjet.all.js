( () => {
    var e = {
        4322: function(e) {
            ...
            function n(e, n) {
                var i, s, o, a, l = e.split(";").filter(r), c = (i = l.shift(),
                s = "",
                o = "",
                (a = i.split("=")).length > 1 ? (s = a.shift(),
                o = a.join("=")) : o = i,
                {
                    name: s,
                    value: o
            ...
            function i(e, i) {
                ...
                if (e.headers)
                    if ("function" == typeof e.headers.getSetCookie)
                        ...
                        s || !e.headers.cookie || i.silent || console.warn("Warning: set-cookie-parser appears to have been called on a request object. It is designed to parse Set-Cookie headers from responses, not Cookie headers from requests. Set the option {silent: true} to suppress this warning."),
                        e = s
                    }
                ...
                for (; a < e.length; ) {
                    ...
                    s = !1; l(); )
                        if ("," === (r = e.charAt(a))) {
                            ...
                            a += 1,
                            l(),
                            i = a; a < e.length && "=" !== (r = e.charAt(a)) && ";" !== r && "," !== r; )
                                a += 1;
                            a < e.length && "=" === e.charAt(a) ? (s = !0,
                            a = i,
            ...
            class g {
                ...
                constructor(e) {
                    ...
                    n.pX in e)
                        ...
                        Error();
                    d.iswindow ? n.pX in e.parent ? this.box = e.parent[n.pX].box : n.pX in e.top ? this.box = e.top[n.pX].box : e.opener && n.pX in e.opener ? this.box = e.opener[n.pX].box : (f.warn("Creating SingletonBox"),
                    this.box = new h.SingletonBox(this)) : this.box = new h.SingletonBox(this),
                    ...
                    this.descriptors = {
                        store: new Proxy({},{
                            get: (e, r) => {
                                ...
                                if (!s)
                                    return;
                                let o = t.natives.call("Object.getOwnPropertyDescriptor", null, s, i);
                                return e[r] = o,
                                e[r]
                            }
                        }),
                ...
                RawProxy(e, t, r) {
                    ...
                    delete e[t];
                    let s = {};
                    r.construct && (s.construct = function(e, t, n) {
                        let i, s = !1, o = {
                            fn: e,
                            this: null,
                            args: t,
                        ...
                        return (r.construct(o),
                        s) ? i : Reflect.construct(o.fn, o.args, o.newTarget)
                    }
                    ),
                    r.apply && (s.apply = function(e, t, n) {
                        let i, s = !1, o = {
                            fn: e,
                            this: t,
                            args: n,
                        ...
                        return (Error.prepareStackTrace = a,
                        s) ? i : Reflect.apply(o.fn, o.this, o.args)
                    }
                    ),
                ...
                Trap(e, t) {
                    ...
                    if (!i)
                        return;
                    let s = this.natives.call("Object.getOwnPropertyDescriptor", null, i, n);
                    return this.descriptors.store[e] = s,
                    this.RawTrap(i, n, t)
                }
                RawTrap(e, t, r) {
                    if (!e || !t || !Reflect.has(e, t))
                    ...
                    : n?.get && (s.get = n.get),
                    r.set ? s.set = function(e) {
                        i.this = this,
                        r.set(i, e)
                    }
                    : n?.set && (s.set = n.set),
                    r.enumerable ? s.enumerable = r.enumerable : n?.enumerable && (s.enumerable = n.enumerable),
                    r.configurable ? s.configurable = r.configurable : n?.configurable && (s.configurable = n.configurable),
                        ...
                        let t = e.get()
                          , r = new Proxy(t,{
                            get(e, n, i) {
                                ...
                                return "length" === n ? Object.keys(r).length : "getNamedItem" === n ? e => r[e] : "getNamedItemNS" === n ? (e, t) => r[`${e}:${t}`] : n in NamedNodeMap.prototype && "function" == typeof s ? new Proxy(s,{
                                    apply: (e, n, i) => n === r ? Reflect.apply(e, t, i) : Reflect.apply(e, n, i)
                                }) : "string" != typeof n && "number" != typeof n || isNaN(Number(n)) ? this.has(e, n) ? s : void 0 : t[Object.keys(r)[n]]
                            },
                            ownKeys(e) {
            ...
            function d(e, t) {
                    ...
                    for (let n of r[t]) {
                        ...
                        Object.defineProperty(n.prototype, t, {
                            get() {
                                ...
                                a.v2)(r.get.call(this)) : r.get.call(this)
                            },
                            set(e) {
                ...
                e.Proxy("Element.prototype.setAttributeNS", {
                    apply(t) {
                        ...
                        o && (t.args[2] = o.fn(s, e.meta, e.cookieStore),
                ...
                e.Trap("Element.prototype.innerHTML", {
                    set(r, n) {
                        ...
                        if (r.this instanceof t.HTMLScriptElement)
                            a = (0,
                            o.o)(n, "(anonymous script element)", e.meta),
                            e.natives.call("Element.prototype.setAttribute", r.this, "scramjet-attr-script-source-src", btoa(Array.from(u.encode(a), e => String.fromCodePoint(e)).join("")));
                ...
                e.Proxy("Element.prototype.setHTMLUnsafe", {
                    apply(t) {
                        try {
                            t.args[0] = (0,
                            s.Qs)(t.args[0], e.cookieStore, e.meta, !1)
                        } catch {}
                    }
                }),
                ...
                e.Proxy("Element.prototype.insertAdjacentHTML", {
                    apply(t) {
                        if (t.args[1])
                            try {
                                t.args[1] = (0,
                                s.Qs)(t.args[1], e.cookieStore, e.meta, !1)
                            } catch {}
                    }
                }),
                e.Proxy("Audio", {
        ...
        3696: function(e, t, r) {
            ...
            function o(e, t) {
                ...
                for (let r of ["protocol", "hash", "host", "hostname", "href", "origin", "pathname", "port", "search"]) {
                    let i = e.natives.call("Object.getOwnPropertyDescriptor", null, a, r);
                    if (!i)
                        continue;
                    let s = {
                        configurable: !0,
                    ...
                    i.get && (s.get = new Proxy(i.get,{
                        apply: () => e.url[r]
                    })),
                    i.set && (s.set = new Proxy(i.set,{
                        apply(i, s, o) {
                            if ("href" === r) {
                                e.url = o[0];
                                return
        ...
        582: function(e, t, r) {
            ...
            function o(e, t) {
                ...
                t.$scramdbg = function(e, t) {
                    return e && "object" == typeof e && e.length > 0 && s(e),
                    s(t),
                    t
                }
                ,
            ...
            function s(e, t) {
                ...
                Object.defineProperty(t, n.$W.globals.importfn, {
                    value: function(t, n) {
                        ...
                        return n.includes(":") || n.startsWith("/") || n.startsWith(".") || n.startsWith("..") ? r(`return import("${(0,
                        i.Oy)(s, e.meta)}?type=module")`)() : r(`return import("${n}")`)()
                    },
                    writable: !1,
                    configurable: !1,
                    enumerable: !1
        ...
        1320: function(e, t, r) {
            ...
            function o(e) {
                n.iswindow && e.Proxy("window.postMessage", {
                    apply(e) {
                        let {constructor: {constructor: t}} = "object" == typeof e.args[0] && null !== e.args[0] ? e.args[0] : "object" == typeof e.args[2] && null !== e.args[2] ? e.args[2] : e.this && s.POLLUTANT in e.this && "object" == typeof e.this[s.POLLUTANT] && null !== e.this[s.POLLUTANT] ? e.this[s.POLLUTANT] : {}
                ...
                e.Proxy("WebSocket", {
                    construct(n) {
                        ...
                        s.addEventListener("message", async e => {
                            let t = e.data;
                            "string" == typeof t || ("byteLength" in t ? "blob" === o.binaryType ? t = new Blob([t]) : Object.setPrototypeOf(t, ArrayBuffer.prototype) : "arrayBuffer" in t && "arraybuffer" === o.binaryType && Object.setPrototypeOf(t = await t.arrayBuffer(), ArrayBuffer.prototype)),
                            a(new MessageEvent("message",{
                                data: t,
                                origin: e.origin,
        ...
        581: function(e, t, r) {
            ...
            function a(e, t) {
                return function(r, s) {
                    ...
                    if (r === t.eval)
                        return o.indirectEval.bind(e, s);
                    if (n.iswindow) {
                        if (r === t.parent)
                            if (i.pX in t.parent)
                                return t.parent;
            ...
            function c(e, t) {
                ...
                Object.defineProperty(t, s.$W.globals.wrappropertyfn, {
                    value: function(e) {
                        return "location" === e || "parent" === e || "top" === e || "eval" === e ? s.$W.globals.wrappropertybase + e : e
                    },
                    writable: !1,
                    configurable: !1,
                    enumerable: !1
                ...
                Object.defineProperty(t.Object.prototype, s.$W.globals.wrappropertybase + "location", {
                    get: function() {
                ...
                Object.defineProperty(t.Object.prototype, s.$W.globals.wrappropertybase + "parent", {
                    get: function() {
                ...
                Object.defineProperty(t.Object.prototype, s.$W.globals.wrappropertybase + "top", {
                    get: function() {
                ...
                Object.defineProperty(t.Object.prototype, s.$W.globals.wrappropertybase + "eval", {
                    get: function() {
        ...
        8409: function(e, t, r) {
            r.r(t),
            r.d(t, {
                ScramjetServiceWorkerRuntime: () => s
            });
            var n = r(1472)
              , i = r(8665).A;
            class s {
        ...
        3402: function(e, t, r) {
            ...
            class a extends EventTarget {
                ...
                async openIDB() {
                    ...
                    return new Promise( (t, r) => {
                        ...
                        e.onupgradeneeded = () => {
                            ...
                            t.objectStoreNames.contains("redirectTrackers") || t.createObjectStore("redirectTrackers"),
                            t.objectStoreNames.contains("referrerPolicies") || t.createObjectStore("referrerPolicies"),
                            t.objectStoreNames.contains("publicSuffixList") || t.createObjectStore("publicSuffixList")
                        }
                        ,
                        e.onerror = () => r(e.error)
                    }
                ...
                async #e() {
                    if (!this.db)
                        return void console.error("Store not ready!");
                    let e = this.db.transaction("config", "readwrite").objectStore("config").put(n.$W, "config");
                    return new Promise( (t, r) => {
                        e.onsuccess = t,
                        e.onerror = r
                    }
  ...
  `, `${"debug" === e ? "color: gray" : ""}`, ...i)
            ...
            class s {
                ...
                getCookies(e, t) {
                    ...
                    for (let s of n) {
                        ...
                        (!s.secure || "https:" === e.protocol) && (!s.httpOnly || !t) && e.pathname.startsWith(s.path) && (!s.domain.startsWith(".") || e.hostname.endsWith(s.domain.slice(1))) && i.push(s)
                    }
        ...
        2614: function(e, t, r) {
            ...
            function o(e, t, r) {
                ...
                )).replace(/@import\s+(url\s*?\(.{0,9999}?\)|['"].{0,9999}?['"]|.{0,9999}?)($|\s|;)/gm, (t, i) => t.replace(i, i.replace(/^(url\(['"]?|['"]|)(.+?)(['"]|['"]?\)|)$/gm, (t, i, s, o) => {
                    if (i.startsWith("url"))
                        return t;
                    let a = "rewrite" === e ? (0,
                    n.Oy)(s.trim(), r) : (0,
        ...
        4435: function(e, t, r) {
            ...
            var n = r(1472)
              , i = r(8228);
            let s = new Set(["cross-origin-embedder-policy", "cross-origin-opener-policy", "cross-origin-resource-policy", "content-security-policy", "content-security-policy-report-only", "expect-ct", "feature-policy", "origin-isolation", "strict-transport-security", "upgrade-insecure-requests", "x-content-type-options", "x-download-options", "x-frame-options", "x-permitted-cross-domain-policies", "x-powered-by", "x-xss-protection", "clear-site-data"])
            ...
            async function l(e, t, r, l) {
                ...
                for (let e of o)
                    c[e] && (c[e] = (0,
                    n.Oy)(c[e]?.toString(), t));
                if ("string" == typeof c.link ? c.link = a(c.link, t) : Array.isArray(c.link) && (c.link = c.link.map(e => a(e, t))),
                        ...
                        t.attribs) {
                            for (let e of u.V)
                                for (let i in e) {
                                    ...
                                    if ("function" != typeof s && ("*" === s || s.includes(t.name)) && void 0 !== t.attribs[i]) {
                                        let s = t.attribs[i]
                                          , o = e.fn(s, n, r);
                ...
                try {
                    let o = function(e, t, r, n=!1) {
                        return function(e, t, r, n) {
                            ...
                            i.nb)(r);
                            try {
                                let a, l = performance.now();
                                a = "string" == typeof e ? o.rewrite_js(e, r.base.href, t || "(unknown)", n) : o.rewrite_js_bytes(e, r.base.href, t || "(unknown)", n),
                    ...
                    n.U5)("sourcemaps", r.base)) {
                        ...
                        if (e)
                            e(Array.from(o.map), o.tag);
                        else {
                            l instanceof Uint8Array && (l = new TextDecoder().decode(l));
                            let e = `${n.$W.globals.pushsourcemapfn}([${o.map.join(",")}], "${o.tag}");`
                              , t = /^\s*(['"])use strict\1;?/;
...
${l}`
                    ...
                    n.U5)("rewriterLogs", r.base))
                        for (let e of o.errors)
                            console.error("oxc parse error", e);
                    return l
                } catch (s) {
                    if (console.warn("failed rewriting js for", t || "(unknown)", s.message, e instanceof Uint8Array ? i.su.decode(e) : e),
                    (0,
        ...
        1561: function(e, t, r) {
            ...
            var i = r(3907)
              ...
              , u = r(884);
            async function d() {
                n = new Uint8Array(await fetch(s.$W.files.wasm).then(e => e.arrayBuffer()))
            }
            ...
            function g(e) {
                ...
                let r = f.findIndex(e => !e.inUse)
                  , d = f.length;
                return -1 === r ? ((0,
                s.U5)("rewriterLogs", e.base) && console.log(`creating new rewriter, ${d} rewriters made already`),
                t = {
                    rewriter: new i.LW({
                        config: s.$W,
                        shared: {
                ...
                f.push(t)) : ((0,
                s.U5)("rewriterLogs", e.base) && console.log(`using cached rewriter ${r} from list of ${d} rewriters`),
                t = f[r]),
                t.inUse = !0,
...
`
                ...
                l("wasm"),
                l("all"),
                o += `$scramjetLoadClient().loadAndHook(${JSON.stringify(n.$W)});`;
                let c = (0,
                i.o)(e, r, s, a);
        ...
        6684: function(e, t, r) {
            ...
            async function s(e) {
                let t = (await i()).transaction("redirectTrackers", "readonly").objectStore("redirectTrackers");
            ...
            async function o(e, t) {
                let r = (await i()).transaction("redirectTrackers", "readwrite").objectStore("redirectTrackers");
            ...
            async function a(e) {
                let t = (await i()).transaction("redirectTrackers", "readwrite").objectStore("redirectTrackers");
            ...
            async function u(e, t) {
                ...
                return (n[t] ?? 0) > i ? (r.mostRestrictiveSite = t,
                await o(e, r),
            ...
            async function h(e, t, r) {
                let n = (await i()).transaction("referrerPolicies", "readwrite").objectStore("referrerPolicies")
                  , s = {
                    policy: t,
                    referrer: r
                };
            ...
            async function p(e) {
                let t = (await i()).transaction("referrerPolicies", "readonly").objectStore("referrerPolicies");
                return new Promise(r => {
                    let n = t.get(e);
                    n.onsuccess = () => r(n.result || null),
                    n.onerror = () => r(null)
        ...
        8228: function(e, t, r) {
            ...
            async function o(e) {
                let t = (await i()).transaction("publicSuffixList", "readwrite").objectStore("publicSuffixList");
...
self.WASM = '${r}';`,
                    ...
                    for (let[e,t] of [...a.searchParams.entries()]) {
                        ...
                        case "parentFrame":
                            ...
                            break;
                        default:
                            f.warn(`${a.href} extraneous query parameter ${e}. Assuming <form> element`),
                            d[e] = t
                        }
                    ...
                    if (a.pathname.startsWith(`${this.config.prefix}blob:`) || a.pathname.startsWith(`${this.config.prefix}data:`)) {
                        let t, r = a.pathname.substring(this.config.prefix.length);
                    ...
                    x ? (m.set("Sec-Fetch-Dest", "document"),
                    m.set("Sec-Fetch-Mode", "navigate")) : (m.set("Sec-Fetch-Dest", e.destination || "empty"),
                    m.set("Sec-Fetch-Mode", e.mode));
                    let v = "none";
                    if (e.referrer && "" !== e.referrer && "no-referrer" !== e.referrer && e.referrer.includes(c.$W.prefix)) {
                        let t = (0,
                        o.v2)(e.referrer);
                        if (t) {
                            let e = new URL(t);
                    ...
                    await (0,
                    s.rj)(h.toString(), e.referrer ? (0,
                    o.v2)(e.referrer) : null, v),
            ...
            async function y(e, t, r, n, a, l, d, h, p, f, m) {
                let y, S = "navigate" === a && ["document", "iframe"].includes(n), x = await (0,
                u.l)(l.rawHeaders, t, p, {
                    get: s.Yq,
                    set: s.pL
                });
                if (S && x["referrer-policy"] && m && await (0,
                s.pL)(e.href, x["referrer-policy"], m),
                g(l)) {
                    let t = new URL((0,
                    o.v2)(x.location));
                    await (0,
                    s.YH)(e.toString(), t.toString(), x["referrer-policy"]);
                    let n = await (0,
                    i.ps)({
                        origin: t,
                        base: t
                ...
                "text/event-stream" === x.accept && (x["content-type"] = "text/event-stream"),
                delete x["permissions-policy"],
                crossOriginIsolated && ["document", "iframe", "worker", "sharedworker", "style", "script"].includes(n) && (x["Cross-Origin-Embedder-Policy"] = "require-corp",
            ...
            async function b(e, t, r, n, i) {
                ...
                case "script":
                    return (0,
                    a.o)(new Uint8Array(await e.arrayBuffer()), e.finalURL, t, "module" === n);
                case "style":
                    return (0,
                    h.s)(await e.text(), t);
                case "sharedworker":
                    ...
                    addEventListener("message", async ({data: t}) => {
                        if ("scramjet$type" in t) {
                            if ("scramjet$token" in t) {
                                ...
                                delete this.syncPool[t.scramjet$token],
                                e(t);
                                return
                            }
                            if ("registerServiceWorker" === t.scramjet$type)
                                return void this.serviceWorkers.push(new n.H(t.port,t.origin));
                            "cookie" === t.scramjet$type && (this.cookieStore.setCookies([t.cookie], new URL(t.url)),
                            e.result.transaction("cookies", "readwrite").objectStore("cookies").put(JSON.parse(this.cookieStore.dump()), "cookies")),
            ...
            class f extends EventTarget {
                constructor(e, t=[], r, n) {
                    ...
                    this.channel.port1.onmessage = e => {
                        "open" === e.data.type ? i(e.data.args[0]) : "message" === e.data.type ? s(e.data.args[0]) : "close" === e.data.type ? o(e.data.args[0], e.data.args[1]) : "error" === e.data.type && a()
                    }
                    ,
                    r.sendMessage({
                        type: "websocket",
                        ...
                        if ("fetch" === n.type)
                            try {
                                ...
                                await async function(e, t, r) {
                                    ...
                                    n.body instanceof ReadableStream || n.body instanceof ArrayBuffer ? a.call(t, {
                                        type: "fetch",
                                        fetch: n
                                    }, [n.body]) : a.call(t, {
                                        type: "fetch",
                            ...
                            try {
                                ...
                                await async function(e, t, r) {
                                    ...
                                    , t => {
                                        t instanceof ArrayBuffer ? a.call(e.websocket.channel, {
                                            type: "message",
                                            args: [t]
                                        }, [t]) : a.call(e.websocket.channel, {
                                            type: "message",
                                            args: [t]
                                        })
                                    }
                ...
                for (let t = 0; t < c.length; t++)
                    h += function(t, r) {
                        ...
                        case n.vw:
                            return function(t, r) {
                                var n;
                                "foreign" === r.xmlMode && (t.name = null != (n = s.H.get(t.name)) ? n : t.name,
                                ...
                                let o = `<${t.name}`
                                  , c = function(e, t) {
                                    ...
                                    if (!e)
                                        return;
                                    let n = (null != (r = t.encodeEntities) ? r : t.decodeEntities) === !1 ? a : t.xmlMode || "utf8" !== t.encodeEntities ? i.WY : i.Gj;
                                    return Object.keys(e).map(r => {
                                        var i, o;
                                        let a = null != (i = e[r]) ? i : "";
                                        return ("foreign" === t.xmlMode && (r = null != (o = s.L.get(r)) ? o : r),
                                        t.emptyAttrs || t.xmlMode || "" !== a) ? `${r}="${n(a)}"` : r
                                    }
                                    ).join(" ")
                                }(t.attribs, r);
                                return c && (o += ` ${c}`),
                                0 === t.children.length && (r.xmlMode ? !1 !== r.selfClosingTags : r.selfClosingTags && l.has(t.name)) ? (r.xmlMode || (o += " "),
                                o += "/>") : (o += ">",
                                t.children.length > 0 && (o += e(t.children, r)),
                                (r.xmlMode || !l.has(t.name)) && (o += `</${t.name}>`)),
                                o
                            }(t, r);
                        case n.EY:
                            return function(e, t) {
                                var r;
                                let n = e.data || "";
                                return (null != (r = t.encodeEntities) ? r : t.decodeEntities) === !1 || !t.xmlMode && e.parent && o.has(e.parent.name) || (n = t.xmlMode || "utf8" !== t.encodeEntities ? (0,
                                i.WY)(n) : (0,
                                i.X1)(n)),
                                n
                            }(t, r)
        ...
        2146: function(e, t, r) {
            ...
            let i = new Map([[0, 65533], [128, 8364], [130, 8218], [131, 402], [132, 8222], [133, 8230], [134, 8224], [135, 8225], [136, 710], [137, 8240], [138, 352], [139, 8249], [140, 338], [142, 381], [145, 8216], [146, 8217], [147, 8220], [148, 8221], [149, 8226], [150, 8211], [151, 8212], [152, 732], [153, 8482], [154, 353], [155, 8250], [156, 339], [158, 382], [159, 376]])
              , s = null != (n = String.fromCodePoint) ? n : function(e) {
                let t = "";
        ...
        2990: function(e, t, r) {
            ...
            var n, i, s, o, a, l, c, u, d = r(7259), h = r(5949), p = r(2146);
            function f(e) {
            ...
            class g {
                ...
                stateNumericStart(e, t) {
                    return t >= e.length ? -1 : (32 | e.charCodeAt(t)) === a.LOWER_X ? (this.state = c.NumericHex,
                    this.consumed += 1,
                ...
                stateNumericHex(e, t) {
                    ...
                    for (; t < e.length; ) {
                        ...
                        if (!f(i) && (!((n = i) >= a.UPPER_A) || !(n <= a.UPPER_F)) && (!(n >= a.LOWER_A) || !(n <= a.LOWER_F)))
                ...
                emitNumericEntity(e, t) {
                    ...
                    this.errors && (e !== a.SEMI && this.errors.missingSemicolonAfterCharacterReference(),
                    ...
                    this.excess++) {
                        ...
                        this.treeIndex < 0)
                            return 0 === this.result || this.decodeMode === u.Attribute && (0 === i || function(e) {
                                var t;
                                return e === a.EQUALS || (t = e) >= a.UPPER_A && t <= a.UPPER_Z || t >= a.LOWER_A && t <= a.LOWER_Z || f(t)
        ...
        747: function(e, t, r) {
            ...
            let n = /["$&'<>\u0080-\uFFFF]/g
              ...
              , s = null == String.prototype.codePointAt ? (e, t) => (64512 & e.charCodeAt(t)) == 55296 ? (e.charCodeAt(t) - 55296) * 1024 + e.charCodeAt(t + 1) - 56320 + 65536 : e.charCodeAt(t) : (e, t) => e.codePointAt(t);
            function o(e) {
                let t, r = "", o = 0;
                for (; null !== (t = n.exec(e)); ) {
                    let {index: a} = t
                      , l = e.charCodeAt(a)
                      , c = i.get(l);
                    void 0 === c ? (r += `${e.substring(o, a)}&#x${s(e, a).toString(16)};`,
                    o = n.lastIndex += Number((64512 & l) == 55296)) : (r += e.substring(o, a) + c,
                    o = a + 1)
                }
                return r + e.substr(o)
            }
            ...
            let l = a(/["&\u00A0]/g, new Map([[34, "&quot;"], [38, "&amp;"], [160, "&nbsp;"]]))
              , c = a(/[&<>\u00A0]/g, new Map([[38, "&amp;"], [60, "&lt;"], [62, "&gt;"], [160, "&nbsp;"]]))
        },
        7259: function(e, t, r) {
            r.d(t, {
                q: () => n
        ...
        4645: function(e, t, r) {
            ...
            var n = r(5645)
              , i = r(2990);
            let s = new Set(["input", "option", "optgroup", "select", "button", "datalist", "textarea"])
              , o = new Set(["p"])
              , a = new Set(["thead", "tbody"])
              , l = new Set(["dd", "dt"])
              , c = new Set(["rt", "rp"])
              , u = new Map([["tr", new Set(["tr", "th", "td"])], ["th", new Set(["th"])], ["td", new Set(["thead", "th", "td"])], ["body", new Set(["head", "link", "script"])], ["li", new Set(["li"])], ["p", o], ["h1", o], ["h2", o], ["h3", o], ["h4", o], ["h5", o], ["h6", o], ["select", s], ["input", s], ["output", s], ["button", s], ["datalist", s], ["textarea", s], ["option", new Set(["option"])], ["optgroup", new Set(["optgroup", "option"])], ["dd", l], ["dt", l], ["address", o], ["article", o], ["aside", o], ["blockquote", o], ["details", o], ["div", o], ["dl", o], ["fieldset", o], ["figcaption", o], ["figure", o], ["footer", o], ["form", o], ["header", o], ["hr", o], ["main", o], ["nav", o], ["ol", o], ["pre", o], ["section", o], ["table", o], ["ul", o], ["rt", c], ["rp", c], ["tbody", a], ["tfoot", a]])
            ...
            class g {
                constructor(e, t={}) {
                    ...
                    this.recognizeSelfClosing = null != (s = t.recognizeSelfClosing) ? s : !this.htmlMode,
                    this.tokenizer = new (null != (o = t.Tokenizer) ? o : n.A)(this.options,this),
                ...
                onclosetag(e, t) {
                    ...
                    this.isVoidElement(u))
                        this.htmlMode && "br" === u && (null == (s = (i = this.cbs).onopentagname) || s.call(i, "br"),
                        null == (a = (o = this.cbs).onopentag) || a.call(o, "br", {}, !0),
                ...
                oncdata(e, t, r) {
                    ...
                    null == (l = (a = this.cbs).oncdataend) || l.call(a)) : (null == (u = (c = this.cbs).oncomment) || u.call(c, `[CDATA[${p}]]`),
        ...
        5645: function(e, t, r) {
            ...
            class p {
                ...
                stateText(e) {
                    e === o.Lt || !this.decodeEntities && this.fastForwardTo(o.Lt) ? (this.index > this.sectionStart && this.cbs.ontext(this.sectionStart, this.index),
                    this.state = a.BeforeTagName,
                    this.sectionStart = this.index) : this.decodeEntities && e === o.Amp && this.startEntity()
                }
                ...
                stateInSpecialTag(e) {
                    ...
                    (32 | e) === this.currentSequence[this.sequenceIndex] ? this.sequenceIndex += 1 : 0 === this.sequenceIndex ? this.currentSequence === h.TitleEnd ? this.decodeEntities && e === o.Amp && this.startEntity() : this.fastForwardTo(o.Lt) && (this.sequenceIndex = 1) : this.sequenceIndex = Number(e === o.Lt)
                }
                stateCDATASequence(e) {
                    e === h.Cdata[this.sequenceIndex] ? ++this.sequenceIndex === h.Cdata.length && (this.state = a.InCommentLike,
                ...
                stateInCommentLike(e) {
                    ...
                    this.state = a.Text) : 0 === this.sequenceIndex ? this.fastForwardTo(this.currentSequence[0]) && (this.sequenceIndex = 1) : e !== this.currentSequence[this.sequenceIndex - 1] && (this.sequenceIndex = 0)
                }
                isTagStartChar(e) {
                ...
                stateBeforeTagName(e) {
                    if (e === o.ExclamationMark)
                        ...
                        this.xmlMode ? this.state = a.InTagName : t === h.ScriptEnd[2] ? this.state = a.BeforeSpecialS : t === h.TitleEnd[2] || t === h.XmpEnd[2] ? this.state = a.BeforeSpecialT : this.state = a.InTagName
                    } else
                        e === o.Slash ? this.state = a.BeforeClosingTagName : (this.state = a.Text,
                        this.stateText(e))
                }
                stateInTagName(e) {
                ...
                stateBeforeClosingTagName(e) {
                    u(e) || (e === o.Gt ? this.state = a.Text : (this.state = this.isTagStartChar(e) ? a.InClosingTagName : a.InSpecialComment,
                    this.sectionStart = this.index))
                }
                stateInClosingTagName(e) {
                    (e === o.Gt || u(e)) && (this.cbs.onclosetag(this.sectionStart, this.index),
                    this.sectionStart = -1,
                    this.state = a.AfterClosingTagName,
                    this.stateAfterClosingTagName(e))
                }
                stateAfterClosingTagName(e) {
                    (e === o.Gt || this.fastForwardTo(o.Gt)) && (this.state = a.Text,
                    this.sectionStart = this.index + 1)
                }
                stateBeforeAttributeName(e) {
                    e === o.Gt ? (this.cbs.onopentagend(this.index),
                    this.isSpecial ? (this.state = a.InSpecialTag,
                    this.sequenceIndex = 0) : this.state = a.Text,
                    this.sectionStart = this.index + 1) : e === o.Slash ? this.state = a.InSelfClosingTag : u(e) || (this.state = a.InAttributeName,
                    this.sectionStart = this.index)
                }
                stateInSelfClosingTag(e) {
                    e === o.Gt ? (this.cbs.onselfclosingtag(this.index),
                    this.state = a.Text,
                    this.sectionStart = this.index + 1,
                    this.isSpecial = !1) : u(e) || (this.state = a.BeforeAttributeName,
                    this.stateBeforeAttributeName(e))
                }
                stateInAttributeName(e) {
                    (e === o.Eq || d(e)) && (this.cbs.onattribname(this.sectionStart, this.index),
                    this.sectionStart = this.index,
                    this.state = a.AfterAttributeName,
                    this.stateAfterAttributeName(e))
                }
                stateAfterAttributeName(e) {
                    e === o.Eq ? this.state = a.BeforeAttributeValue : e === o.Slash || e === o.Gt ? (this.cbs.onattribend(l.NoValue, this.sectionStart),
                    this.sectionStart = -1,
                    this.state = a.BeforeAttributeName,
                ...
                stateBeforeAttributeValue(e) {
                    e === o.DoubleQuote ? (this.state = a.InAttributeValueDq,
                    this.sectionStart = this.index + 1) : e === o.SingleQuote ? (this.state = a.InAttributeValueSq,
                ...
                handleInAttributeValue(e, t) {
                    ...
                    this.sectionStart = -1,
                    this.cbs.onattribend(t === o.DoubleQuote ? l.Double : l.Single, this.index + 1),
                    this.state = a.BeforeAttributeName) : this.decodeEntities && e === o.Amp && this.startEntity()
                }
                ...
                stateInAttributeValueNoQuotes(e) {
                    u(e) || e === o.Gt ? (this.cbs.onattribdata(this.sectionStart, this.index),
                    this.sectionStart = -1,
                    this.cbs.onattribend(l.Unquoted, this.index),
                    this.state = a.BeforeAttributeName,
                    this.stateBeforeAttributeName(e)) : this.decodeEntities && e === o.Amp && this.startEntity()
                }
                stateBeforeDeclaration(e) {
                    e === o.OpeningSquareBracket ? (this.state = a.CDATASequence,
                    this.sequenceIndex = 0) : this.state = e === o.Dash ? a.BeforeComment : a.InDeclaration
                }
                stateInDeclaration(e) {
                    (e === o.Gt || this.fastForwardTo(o.Gt)) && (this.cbs.ondeclaration(this.sectionStart, this.index),
                    this.state = a.Text,
                    this.sectionStart = this.index + 1)
                }
                stateInProcessingInstruction(e) {
                    (e === o.Gt || this.fastForwardTo(o.Gt)) && (this.cbs.onprocessinginstruction(this.sectionStart, this.index),
                    this.state = a.Text,
                    this.sectionStart = this.index + 1)
                }
                stateBeforeComment(e) {
                    e === o.Dash ? (this.state = a.InCommentLike,
                    this.currentSequence = h.CommentEnd,
                    this.sequenceIndex = 2,
                    this.sectionStart = this.index + 1) : this.state = a.InDeclaration
                }
                stateInSpecialComment(e) {
                    (e === o.Gt || this.fastForwardTo(o.Gt)) && (this.cbs.oncomment(this.sectionStart, this.index, 0),
                    this.state = a.Text,
                    this.sectionStart = this.index + 1)
                }
                stateBeforeSpecialS(e) {
                    let t = 32 | e;
                    t === h.ScriptEnd[3] ? this.startSpecial(h.ScriptEnd, 4) : t === h.StyleEnd[3] ? this.startSpecial(h.StyleEnd, 4) : (this.state = a.InTagName,
                    this.stateInTagName(e))
                }
                ...
                startEntity() {
                    ...
                    this.entityDecoder.startEntity(this.xmlMode ? c.FJ.Strict : this.baseState === a.Text || this.baseState === a.InSpecialTag ? c.FJ.Legacy : c.FJ.Attribute)
                }
                stateInEntity() {
                ...
                cleanup() {
                    this.running && this.sectionStart !== this.index && (this.state === a.Text || this.state === a.InSpecialTag && 0 === this.sequenceIndex ? (this.cbs.ontext(this.sectionStart, this.index),
                    this.sectionStart = this.index) : (this.state === a.InAttributeValueDq || this.state === a.InAttributeValueSq || this.state === a.InAttributeValueNq) && (this.cbs.onattribdata(this.sectionStart, this.index),
                    this.sectionStart = this.index))
                }
                shouldContinue() {
                ...
                finish() {
                    this.state === a.InEntity && (this.entityDecoder.end(),
                ...
                emitCodePoint(e, t) {
                    this.baseState !== a.Text && this.baseState !== a.InSpecialTag ? (this.sectionStart < this.entityStart && this.cbs.onattribdata(this.sectionStart, this.entityStart),
        ...
        3907: function(e, t, r) {
            ...
            function s(e, t) {
                try {
                    ...
                    let e = function(e) {
                        ...
                        return n.__wbindgen_export_2.set(t, e),
                        t
                    }(t);
            ...
            let a = null;
            function l() {
                return (null === a || 0 === a.byteLength) && (a = new Uint8Array(n.memory.buffer)),
                a
            }
            function c(e, t) {
                return e >>>= 0,
                o.decode(l().subarray(e, e + t))
            }
            let u = 0
            ...
            class b {
                ...
                rewrite_js_bytes(e, t, r, i) {
                    let s = function(e, t) {
                      ...
                      , h = u
                      , f = n.rewriter_rewrite_js_bytes(this.__wbg_ptr, s, o, a, c, d, h, i);
                    if (f[2])
                        throw m(f[1]);
                    return m(f[0])
                }
